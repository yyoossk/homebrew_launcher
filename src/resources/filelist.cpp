...
extern const u8 buttonSelected_png[];
extern const u32 buttonSelected_png_size;
...
extern const u8 homebrewButtonSelected_png[];
extern const u32 homebrewButtonSelected_png_size;
